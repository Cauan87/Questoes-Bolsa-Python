def comprar_frutas(morango=0, uva=0):
    ...
    pago pelo cliente.
    '''
    preco_morango_kg = 2.50 if morango <= 5 else 2.20
    preco_uva_kg = 1.80 if uva <= 5 else 1.50
    preco_total = custo(uva, preco_uva_kg) + custo(morango, preco_morango_kg)

    if morango + uva > 8 or preco_total > 25.00:
